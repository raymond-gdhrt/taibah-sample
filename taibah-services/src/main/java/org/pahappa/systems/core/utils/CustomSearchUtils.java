...
public class CustomSearchUtils {
    ...
    public static Search genereateSearchObjectForProducts(String searchTerm,  SortField selectedSortField) {
        Search search = generateSearchTerms(searchTerm, Arrays.asList("name"));
